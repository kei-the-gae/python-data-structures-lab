...
def manage_students():
    # your code here
    student_names = ['Kei', 'Avery', 'Kayleigh']
...
def hometown_info():
    # your code here
    home_town = {'city': 'Gulfport', 'state': 'Mississippi', 'population': 72236}
    home_town_message = f'I was born in {home_town['city']}, {home_town['state']} - population of {'{:,}'.format(home_town['population'])}.'
